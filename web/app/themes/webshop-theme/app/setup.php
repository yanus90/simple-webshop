...
add_action('wp_enqueue_scripts', function () {
    // Replace default jquery, remove jquery-migrate.
    ...
    wp_register_style('fontawesome-cdn', 'https://pro.fontawesome.com/releases/v5.11.2/css/all.css');
    ...
    wp_enqueue_style('font/nunito', 'https://fonts.googleapis.com/css2?family=Nunito:ital,wght@0,300;0,400;0,600;0,700;0,800;1,300;1,400;1,600;1,700;1,800');
